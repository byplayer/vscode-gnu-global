...
const supportLanguages = ["cpp", "c", "php", "javascript", "javascriptreact"];
...
export function activate(context: vscode.ExtensionContext) {
  ...
  disposables.push(
    vscode.languages.registerWorkspaceSymbolProvider(
      new WorkspaceSymbolProvider(global)
    )
  );

  disposables.push(
    vscode.commands.registerCommand(
      "extension.showGlobalVersion",
  ...
  disposables.push(
    vscode.commands.registerCommand(
      "extension.rebuildGtags",
      rebuildGtagsHandler.rebuildGtags,
      rebuildGtagsHandler
    )
  );
  disposables.push(
